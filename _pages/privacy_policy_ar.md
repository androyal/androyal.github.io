...
- المعلومات الشخصية العامة مثل العمر والجنس.
...
### المعلنين الخارجيين
قد نتعامل مع شركات خارجية لعرض الإعلانات داخل التطبيق. قد تستخدم هذه الشركات معلومات حول زياراتك للتطبيق ومواقع الويب الأخرى، والتي يتم جمعها من خلال ملفات تعريف الارتباط (الكوكيز)، لتقديم إعلانات مخصصة وفقًا لاهتماماتك. جميع شركائنا ملتزمون باحترام الحقوق القانونية الأساسية للمستخدمين فيما يتعلق بحماية البيانات والخصوصية.

[سياسة الخصوصية لاب فيستور AppVestor](https://legal.appvestor.com/privacy-policy/)
